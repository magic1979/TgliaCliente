...
function buildmenu() {
	...
	$.ajax({
		   ...
		   $.each(result, function(i,item){
				  ...
				  tabella = tabella + "<table width='100%' height='100px' class='tabella1'><tr><td><table bgcolor='#fff' width='100%' border='0'><tr><td width='30%'><a onclick='#' href='catalogo.html?catalogo="+ item.Catalogo +"' rel='external'><img src='http://www.gtechplay.com/public/bck/"+ item.IMG +".png' width='100' class='circolare2'></a></td><td width='60%'><a onclick='#' href='catalogo.html?catalogo="+ item.Catalogo +"' rel='external'><h2 class='visione'>&nbsp;"+ item.Catalogo +"</h2><p class='visione'>"+ item.Descrizione +"</p></a></td><td align='right'><a id='add_"+item.Catalogo+"'  rel='external'><img src='img/arrowD.png' width='40'></a></td></tr></table></td></tr></table><br>";
				  
				 
                  $(document).on("tap", "#add_"+item.Catalogo+"", function(e){
                                 
                     var numerofesta = this.id
                     numerofesta = numerofesta.replace("add_","")
                     
                     window.location.href = "catalogo.html?catalogo="+ numerofesta +"";
