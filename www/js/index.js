		   ...
		   $.each(result, function(i,item){
				...
				if (item.ID != 0){
				  ...
				  if (model== "Ipad") {
					...
					landmark2 = landmark2 + "<div id="+ item.Cod_Prodotto +"'><a style='text-decoration: none;' id='add_"+item.Cod_Prodotto+"' rel='external' onclick='#' data-transition='slide' id='linkdettagli"+ item.Cod_Prodotto +"'><img src='http://gtechplay.com/public/bck/"+ item.IMG +".png' width='100%'><table height='30px' border='0' width='320px'><tr><td align='left' colspan='2'><font size='3' color='#FFFFFF'>"+ item.Descrizione +"</font></td></tr><tr><td align='left' width='160px'><br><font size='2' color='#FFFFFF'>Acquistati:</font><font size='2' color='#0e85af'> "+ item.Acquistati +"</font></td><td align='right'><br><font size='2' color='#FFFFFF'>Vale:<strike>"+ item.Valore +"&euro;</strike> "+ item.Sconto +"%</font></font></td></tr><tr><td align='left' width='160px' valign='center'><font size='2' color='#FFFFFF'>Scade tra: </font><font size='2' color='#FFFFFF'>"+ item.GiorniRimanenti +" </font><font size='2' color='#FFFFFF'>giorni</font></td><td id='deallo"+ item.Cod_Prodotto +"' colspan='2' align='right'><font size='5' color='#FFFFFF'>"+ item.Deal +"&euro;</font></td></tr><tr id='vis2"+ item.Cod_Prodotto +"' style='display:none' class='visione'><td align='left' colspan='2'><font size='1' color='#FFFFFF' class='someclass'>"+ item.Dettagli +"</font></td></tr></table></a><br><hr class='div3'></div>";
